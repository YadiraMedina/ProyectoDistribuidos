 ...
 implements ClienteApp.ClienteOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("eliminarCliente", new java.lang.Integer (1));
    _methods.put ("actualizarCliente", new java.lang.Integer (2));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // ClienteApp/Cliente/insertarCliente
       {
         ...
         $result = this.insertarCliente (identificacion, nombre, telefono);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 1:  // ClienteApp/Cliente/eliminarCliente
       {
       ...
       case 2:  // ClienteApp/Cliente/actualizarCliente
       {
         int id_cliente = in.read_long ();
         int identificacion = in.read_long ();
         String nombre = in.read_wstring ();
         String telefono = in.read_wstring ();
         boolean $result = false;
         $result = this.actualizarCliente (id_cliente, identificacion, nombre, telefono);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
